...
func TestThunkID(t *testing.T) {
	vals := []koinos.ThunkID{
		...
		koinos.ThunkIDHash,
		koinos.ThunkIDRecoverPublicKey,
		...
		koinos.ThunkIDGetContractID,
		koinos.ThunkIDGetHeadBlockTime,
		koinos.ThunkIDGetAccountNonce,
	}
...
func getInvalidThunkID() koinos.ThunkID {
	w := koinos.ThunkIDGetAccountNonce
...
func TestSystemCallID(t *testing.T) {
	vals := []koinos.SystemCallID{
		...
		koinos.SystemCallIDRecoverPublicKey,
		...
		koinos.SystemCallIDGetContractID,
		koinos.SystemCallIDGetHeadBlockTime,
		koinos.SystemCallIDGetAccountNonce,
	}
...
func getInvalidSystemCallID() koinos.SystemCallID {
	w := koinos.SystemCallIDGetAccountNonce
...
func TestRecoverPublicKeyArgs(t *testing.T) {
	o := koinos.NewRecoverPublicKeyArgs()

	vb := koinos.NewVariableBlob()
	vb = o.Serialize(vb)

	_, _, err := koinos.DeserializeRecoverPublicKeyArgs(vb)
	if err != nil {
		t.Error(err)
	}
	...
	// Test signature_data
	vb = &koinos.VariableBlob{}
	n, _, err = koinos.DeserializeRecoverPublicKeyArgs(vb)
	if err == nil {
		t.Errorf("err == nil")
	}
	if n != 0 {
	...
	jo := koinos.NewRecoverPublicKeyArgs()
	jerr = json.Unmarshal(v, jo)
	if jerr != nil {
		t.Error(jerr)
	}
...
func TestRecoverPublicKeyReturn(t *testing.T) {
	o := koinos.NewRecoverPublicKeyReturn()

	vb := koinos.NewVariableBlob()
	vb = o.Serialize(vb)

	_, _, err := koinos.DeserializeRecoverPublicKeyReturn(vb)
	if err != nil {
		t.Error(err)
	}

	vb = koinos.NewVariableBlob()
	size, _, err := koinos.DeserializeRecoverPublicKeyReturn(vb)
	if err == nil {
		t.Errorf("err == nil")
	}
	if size != 0 {
	...
	jo := koinos.NewRecoverPublicKeyReturn()
	jerr = json.Unmarshal(v, jo)
	if jerr != nil {
		t.Error(jerr)
	}
...
func TestGetContractIDArgs(t *testing.T) {
	o := koinos.NewGetContractIDArgs()

	vb := koinos.NewVariableBlob()
	vb = o.Serialize(vb)

	_, _, err := koinos.DeserializeGetContractIDArgs(vb)
	if err != nil {
		t.Error(err)
	}
	...
	jo := koinos.NewGetContractIDArgs()
	jerr = json.Unmarshal(v, jo)
	if jerr != nil {
		t.Error(jerr)
	}
...
func TestGetContractIDReturn(t *testing.T) {
	o := koinos.NewGetContractIDReturn()

	vb := koinos.NewVariableBlob()
	vb = o.Serialize(vb)

	_, _, err := koinos.DeserializeGetContractIDReturn(vb)
	if err != nil {
		t.Error(err)
	}

	vb = koinos.NewVariableBlob()
	size, _, err := koinos.DeserializeGetContractIDReturn(vb)
	if err == nil {
		t.Errorf("err == nil")
	}
	if size != 0 {
	...
	jo := koinos.NewGetContractIDReturn()
	jerr = json.Unmarshal(v, jo)
	if jerr != nil {
		t.Error(jerr)
	}
...
func TestGetHeadBlockTimeArgs(t *testing.T) {
	o := koinos.NewGetHeadBlockTimeArgs()

	vb := koinos.NewVariableBlob()
	vb = o.Serialize(vb)

	_, _, err := koinos.DeserializeGetHeadBlockTimeArgs(vb)
	if err != nil {
		t.Error(err)
	}
	...
	jo := koinos.NewGetHeadBlockTimeArgs()
	jerr = json.Unmarshal(v, jo)
	if jerr != nil {
		t.Error(jerr)
	}
...
func TestGetHeadBlockTimeReturn(t *testing.T) {
	o := koinos.NewGetHeadBlockTimeReturn()

	vb := koinos.NewVariableBlob()
	vb = o.Serialize(vb)

	_, _, err := koinos.DeserializeGetHeadBlockTimeReturn(vb)
	if err != nil {
		t.Error(err)
	}

	vb = koinos.NewVariableBlob()
	size, _, err := koinos.DeserializeGetHeadBlockTimeReturn(vb)
	if err == nil {
		t.Errorf("err == nil")
	}
	if size != 0 {
	...
	jo := koinos.NewGetHeadBlockTimeReturn()
	jerr = json.Unmarshal(v, jo)
	if jerr != nil {
		t.Error(jerr)
	}
...
func TestGetAccountNonceArgs(t *testing.T) {
	o := koinos.NewGetAccountNonceArgs()

	vb := koinos.NewVariableBlob()
	vb = o.Serialize(vb)

	_, _, err := koinos.DeserializeGetAccountNonceArgs(vb)
	if err != nil {
		t.Error(err)
	}
	...
	// Test account
	vb = &koinos.VariableBlob{}
	n, _, err = koinos.DeserializeGetAccountNonceArgs(vb)
	if err == nil {
		t.Errorf("err == nil")
	}
	if n != 0 {
	...
	jo := koinos.NewGetAccountNonceArgs()
	jerr = json.Unmarshal(v, jo)
	if jerr != nil {
		t.Error(jerr)
	}
...
func TestGetAccountNonceReturn(t *testing.T) {
	o := koinos.NewGetAccountNonceReturn()

	vb := koinos.NewVariableBlob()
	vb = o.Serialize(vb)

	_, _, err := koinos.DeserializeGetAccountNonceReturn(vb)
	if err != nil {
		t.Error(err)
	}
	...
	// Test nonce
	vb = &koinos.VariableBlob{}
	n, _, err = koinos.DeserializeGetAccountNonceReturn(vb)
	if err == nil {
		t.Errorf("err == nil")
	}
	if n != 0 {
	...
	jo := koinos.NewGetAccountNonceReturn()
	jerr = json.Unmarshal(v, jo)
	if jerr != nil {
		t.Error(jerr)
	}
...
func TestGetAccountNonceRequest(t *testing.T) {
	o := koinos.NewGetAccountNonceRequest()

	vb := koinos.NewVariableBlob()
	vb = o.Serialize(vb)

	_, _, err := koinos.DeserializeGetAccountNonceRequest(vb)
	if err != nil {
		t.Error(err)
	}
	...
	// Test account
	vb = &koinos.VariableBlob{}
	n, _, err = koinos.DeserializeGetAccountNonceRequest(vb)
	if err == nil {
		t.Errorf("err == nil")
	}
	if n != 0 {
	...
	jo := koinos.NewGetAccountNonceRequest()
	jerr = json.Unmarshal(v, jo)
	if jerr != nil {
		t.Error(jerr)
	}
...
func TestChainRPCRequest(t *testing.T) {
	...
	{
		v := koinos.NewChainRPCRequest()
		v.Value = koinos.NewGetAccountNonceRequest()
		exerciseChainRPCRequestSerialization(v, t)
...
func TestGetAccountNonceResponse(t *testing.T) {
	o := koinos.NewGetAccountNonceResponse()

	vb := koinos.NewVariableBlob()
	vb = o.Serialize(vb)

	_, _, err := koinos.DeserializeGetAccountNonceResponse(vb)
	if err != nil {
		t.Error(err)
	}
	...
	// Test nonce
	vb = &koinos.VariableBlob{}
	n, _, err = koinos.DeserializeGetAccountNonceResponse(vb)
	if err == nil {
		t.Errorf("err == nil")
	}
	if n != 0 {
	...
	jo := koinos.NewGetAccountNonceResponse()
	jerr = json.Unmarshal(v, jo)
	if jerr != nil {
		t.Error(jerr)
	}
...
func TestChainRPCResponse(t *testing.T) {
	...
	{
		v := koinos.NewChainRPCResponse()
		v.Value = koinos.NewGetAccountNonceResponse()
		exerciseChainRPCResponseSerialization(v, t)
...
func TestOpaqueActiveBlockData(t *testing.T) {
	...
	jerr = json.Unmarshal([]byte("{\"transaction_merkle_root\":[14314,123515,1341234],\"passive_data_merkle_root\":[14314,123515,1341234],\"signer\":[14314,123515,1341234]}"), jo)
	if jerr == nil {
		t.Errorf("jerr == nil")
	}
